...
AriaLogger=(function() {
	var _basePath=null;
    var _ALogger;
    var EnableSendingTelemetryWithOTel=true;
    var EnableSendingTelemetryWithLegacyAria=true;
    ...
    function generateTelemetryEvent(eventName, telemetryData) {
        ...
        var eventNameFull="Office.Extensibility.OfficeJs."+eventName+"XZ";
	...
	function _loadAriaScriptAndLog(tableName, telemetryData) {
        ...
        if(this.EnableSendingTelemetryWithLegacyAria) {
        ...
        if (this.EnableSendingTelemetryWithOTel) {
