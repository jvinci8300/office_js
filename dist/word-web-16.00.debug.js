...
(function (OSFAppTelemetry) {
	...
	function initialize(context) {
		...
		appInfo.hostJSVersion="16.0.11601.10000";
...
(function (Word) {
	...
	var Annotation=(function (_super) {
		...
		Annotation.prototype.getParent=function () {
			return _createMethodObject(Word.AnnotationParent, this, "GetParent", 1, [], false, false, null, 4);
		};
	...
	var _typeAnnotationParent="AnnotationParent";
	var AnnotationParent=(function (_super) {
		__extends(AnnotationParent, _super);
		function AnnotationParent() {
			return _super !==null && _super.apply(this, arguments) || this;
		}
		Object.defineProperty(AnnotationParent.prototype, "_className", {
			get: function () {
		...
		Object.defineProperty(AnnotationParent.prototype, "_scalarPropertyNames", {
			get: function () {
		...
		Object.defineProperty(AnnotationParent.prototype, "object", {
			get: function () {
				_throwIfNotLoaded("object", this._O, _typeAnnotationParent, this._isNull);
				return this._O;
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(AnnotationParent.prototype, "objectType", {
			get: function () {
				_throwIfNotLoaded("objectType", this._Ob, _typeAnnotationParent, this._isNull);
				return this._Ob;
			},
			enumerable: true,
			configurable: true
		});
		AnnotationParent.prototype._handleResult=function (value) {
			_super.prototype._handleResult.call(this, value);
			if (_isNullOrUndefined(value))
				return;
			var obj=value;
			...
			if (!_isUndefined(obj["ObjectType"])) {
				this._Ob=obj["ObjectType"];
			}
		};
		AnnotationParent.prototype.load=function (option) {
			return _load(this, option);
		};
		AnnotationParent.prototype.retrieve=function (option) {
			return _retrieve(this, option);
		};
		AnnotationParent.prototype._handleRetrieveResult=function (value, result) {
			_super.prototype._handleRetrieveResult.call(this, value, result);
			_processRetrieveResult(this, value, result);
		};
		AnnotationParent.prototype.toJSON=function () {
			return _toJson(this, {
				"object": this._O,
				"objectType": this._Ob
			}, {});
		};
		AnnotationParent.prototype.ensureUnchanged=function (data) {
			_invokeEnsureUnchanged(this, data);
			return;
		};
		return AnnotationParent;
	}(OfficeExtension.ClientObject));
	Word.AnnotationParent=AnnotationParent;
	...
	var AnnotationParentObjectType;
	(function (AnnotationParentObjectType) {
		AnnotationParentObjectType["none"]="None";
		AnnotationParentObjectType["document"]="Document";
		AnnotationParentObjectType["paragraph"]="Paragraph";
		AnnotationParentObjectType["annotation"]="Annotation";
	})(AnnotationParentObjectType=Word.AnnotationParentObjectType || (Word.AnnotationParentObjectType={}));
	var ErrorCodes;
	(function (ErrorCodes) {
